...
<?php if ( get_theme_mod('realestate_agent_site_loader', false) == true ) : ?>
	<div class="cssloader">
    	<div class="sh1"></div>
    	<div class="sh2"></div>
    	<h1 class="lt"><?php esc_html_e( 'loading',  'realestate-agent' ); ?></h1>
    </div>
<?php endif; ?>
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-8 align-self-center text-center text-md-right">
				<?php if ( get_theme_mod('realestate_agent_header_email_address') ) : ?>
					<span class="mr-3"><i class="fas fa-envelope mr-3"></i><a href="mailto:<?php echo esc_html(get_theme_mod('realestate_agent_header_email_address','')); ?>"><?php echo esc_html(get_theme_mod('realestate_agent_header_email_address','')); ?></a></span>
				<?php endif; ?>
				<?php if ( get_theme_mod('realestate_agent_header_phone_number') ) : ?>
					<span class="mr-3"><i class="fas fa-phone mr-3"></i><a href="callto:<?php echo esc_html(get_theme_mod('realestate_agent_header_phone_number','')); ?>"><?php echo esc_html(get_theme_mod('realestate_agent_header_phone_number','')); ?></a></span>
				<?php endif; ?>
			</div>
