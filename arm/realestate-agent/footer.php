<footer>
  <div class="container">
            ...
            <div class="container">
              <div class="row sidebar-area footer-area">
                <div id="categories-2" class="col-lg-3 col-md-6 widget_categories">
                    <h4 class="title"><?php esc_html_e('Categories', 'realestate-agent'); ?></h4>
                    <ul>
                        <?php
                ...
                <div id="pages-2" class="col-lg-3 col-md-6 widget_pages">
                    <h4 class="title"><?php esc_html_e('Pages', 'realestate-agent'); ?></h4>
                    <ul>
                        <?php
                        wp_list_pages(array(
                            'title_li' => '',
                ...
                <div id="archives-2" class="col-lg-3 col-md-6 widget_archive">
                    <h4 class="title"><?php esc_html_e('Archives', 'realestate-agent'); ?></h4>
                    <ul>
                        <?php
                ...
                <div id="calendar" class="col-lg-3 col-md-6 widget_calendar">
                  <h4 class="title"><?php esc_html_e('Calendar', 'realestate-agent'); ?></h4>
                  <?php get_calendar(); ?>
                </div>
              </div>
            </div>
    ...
    <?php $realestate_agent_scroll_top_icon = get_theme_mod( 'realestate_agent_scroll_top_icon', 'dashicons dashicons-arrow-up-alt' ); ?>
    <?php if ( get_theme_mod('realestate_agent_scroll_enable_setting', true) == true ) : ?>
      <div class="scroll-up">
          <a href="#tobottom"><span class="dashicons dashicons-<?php echo esc_attr( $realestate_agent_scroll_top_icon ); ?>"></span></a>
      </div>
    <?php endif; ?>
  </div>
</footer>
