...
if ( ! class_exists( 'Realestate_Agent_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Realestate_Agent_WPTT_WebFont_Loader {
		 ...
		 * @var string
		 */
		protected $realestate_agent_css;
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Realestate_Agent_WPTT_WebFont_Loader( $url );
